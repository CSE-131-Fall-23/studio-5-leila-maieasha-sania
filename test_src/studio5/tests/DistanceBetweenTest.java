...
public class DistanceBetweenTest {
	...
	public void testPointsA() {
		...
		assertEquals(1.0, Methods.distanceBetween(1.0, 0.0, 2.0, 0.0), 1.0);
	}
	...
	public void testPointsB() {
		...
		assertEquals(2.0, Methods.distanceBetween(0.0, 1.0, 0.0, -1.0), 2.0);
	}
	...
	public void testPointsC() {
		...
		assertEquals(5.0, Methods.distanceBetween(-1.0, -1.0, 2.0, 3.0), 5.0);
	}
	...
	public void testPointsD() {
		...
		assertEquals(50.0, Methods.distanceBetween(0.0, 30.0, 0.0, 40.0), 50.0);
	}
	/**
